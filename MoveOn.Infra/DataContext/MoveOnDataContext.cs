...
namespace MoveOn.Infra.DataContext
{
    ...
    public class MoveOnDataContextInitializer : DropCreateDatabaseIfModelChanges<MoveOnDataContext>
    {
        protected override void Seed(MoveOnDataContext context)
        {
            ...
            //-- Novos Atendimento
            context.Atendimentos.Add(new Atendimento { Id = 1, ClienteId = 1, ServicoId = 1, MomAbertura = DateTime.Now, Logradouro = "Rua", _Endereco = "Maria da Penha", Numero = "321", Bairro = "Jardim Wanda", CEP = "03232567", Cidade = "São Paulo", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 43213});
            context.Atendimentos.Add(new Atendimento { Id = 2, ClienteId = 2, ServicoId = 2, MomAbertura = DateTime.Now, Logradouro = "Str.", _Endereco = "João Carlos", Numero = "23", Bairro = "Jardim Paulista", CEP = "0398765", Cidade = "Osasco", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 42333 });
            context.Atendimentos.Add(new Atendimento { Id = 3, ClienteId = 3, ServicoId = 3, MomAbertura = DateTime.Now, Logradouro = "Avenida", _Endereco = "Boa Vista", Numero = "11", Bairro = "Vila Esperança", CEP = "2343123", Cidade = "São Paulo", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 33132 });
            context.Atendimentos.Add(new Atendimento { Id = 4, ClienteId = 4, ServicoId = 1, MomAbertura = DateTime.Now, Logradouro = "Rua", _Endereco = "XV Novembro", Numero = "93", Bairro = "Vila Nova", CEP = "6543456", Cidade = "Taboão da Serra", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 43123 });
            context.Atendimentos.Add(new Atendimento { Id = 5, ClienteId = 5, ServicoId = 2, MomAbertura = DateTime.Now, Logradouro = "Avenida", _Endereco = "Paulista", Numero = "32", Bairro = "Vila Natal", CEP = "9876543", Cidade = "São Paulo", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 42322 });
            context.SaveChanges();

            //-- Atendimento Iniciados
            context.Atendimentos.Add(new Atendimento { Id = 6, ClienteId = 1, AteVeiculoId = 1, FuncionarioId = 1, ServicoId = 1, MomAbertura = DateTime.Now, MomInicio = DateTime.Now , Status="urgente", Logradouro = "Estrada", _Endereco = "São Francisco", Numero = "2701", Bairro = "Vila Sonia do Taboao", CEP = "06765001", Cidade = "Taboão da Serra", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 423543 });
            context.Atendimentos.Add(new Atendimento { Id = 7, ClienteId = 2, AteVeiculoId = 2, FuncionarioId = 2, ServicoId = 2, MomAbertura = DateTime.Now, MomInicio = DateTime.Now , Logradouro = "Str.", _Endereco = "João Carlos", Numero = "23", Bairro = "Jardim Paulista", CEP = "0398765", Cidade = "Osasco", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 42353  });
            context.Atendimentos.Add(new Atendimento { Id = 8, ClienteId = 3, AteVeiculoId = 3, FuncionarioId = 3, ServicoId = 3, MomAbertura = DateTime.Now, MomInicio = DateTime.Now , Logradouro = "Avenida", _Endereco = "Boa Vista", Numero = "11", Bairro = "Vila Esperança", CEP = "2343123", Cidade = "São Paulo", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 654321  });
            context.Atendimentos.Add(new Atendimento { Id = 9, ClienteId = 4, AteVeiculoId = 4, FuncionarioId = 1, ServicoId = 1, MomAbertura = DateTime.Now, MomInicio = DateTime.Now , Logradouro = "Rua", _Endereco = "XV Novembro", Numero = "93", Bairro = "Vila Nova", CEP = "6543456", Cidade = "Taboão da Serra", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 442234  });
            context.Atendimentos.Add(new Atendimento { Id = 10, ClienteId = 5, AteVeiculoId = 5, FuncionarioId = 2, ServicoId = 2, MomAbertura = DateTime.Now, MomInicio = DateTime.Now, Logradouro = "Avenida", _Endereco = "Paulista", Numero = "32", Bairro = "Vila Natal", CEP = "9876543", Cidade = "São Paulo", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 4232254323  });
            context.SaveChanges();

            //-- Atendimento Concluídos
            context.Atendimentos.Add(new Atendimento {Id = 11, ClienteId = 1, AteVeiculoId = 1, FuncionarioId = 1, ServicoId = 1, MomAbertura = DateTime.Now, MomInicio = DateTime.Now, MomConclusao = DateTime.Now, InfoConclusao = "A" , Logradouro = "Rua", _Endereco = "Maria da Penha", Numero = "321", Bairro = "Vila Sonia do Taboao", CEP = "03232567", Cidade = "São Paulo", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 34321 });
            context.Atendimentos.Add(new Atendimento {Id = 12, ClienteId = 2, AteVeiculoId = 2, FuncionarioId = 2, ServicoId = 2,  MomAbertura = DateTime.Now, MomInicio = DateTime.Now, MomConclusao = DateTime.Now, InfoConclusao = "B", Logradouro = "Str.", _Endereco = "João Carlos", Numero = "23", Bairro = "Jardim Paulista", CEP = "0398765", Cidade = "Osasco", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 423 });
            context.Atendimentos.Add(new Atendimento {Id = 13, ClienteId = 3, AteVeiculoId = 3, FuncionarioId = 3, ServicoId = 3,  MomAbertura = DateTime.Now, MomInicio = DateTime.Now, MomConclusao = DateTime.Now, InfoConclusao = "C", Logradouro = "Avenida", _Endereco = "Boa Vista", Numero = "11", Bairro = "Vila Esperança", CEP = "2343123", Cidade = "São Paulo", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 223232 });
            context.Atendimentos.Add(new Atendimento {Id = 14, ClienteId = 4, AteVeiculoId = 4, FuncionarioId = 1, ServicoId = 1,  MomAbertura = DateTime.Now, MomInicio = DateTime.Now, MomConclusao = DateTime.Now, InfoConclusao = "D", Logradouro = "Rua", _Endereco = "XV Novembro", Numero = "93", Bairro = "Vila Nova", CEP = "6543456", Cidade = "Taboão da Serra", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 43213 });
            context.Atendimentos.Add(new Atendimento {Id = 15, ClienteId = 5, AteVeiculoId = 5, FuncionarioId = 2, ServicoId = 2,  MomAbertura = DateTime.Now, MomInicio = DateTime.Now, MomConclusao = DateTime.Now, InfoConclusao = "E", Logradouro = "Avenida", _Endereco = "Paulista", Numero = "32", Bairro = "Vila Natal", CEP = "9876543", Cidade = "São Paulo", Estado = "SP", Pais = "Brasil", CoordenadaX = 12345, CoordenadaY = 42322 });
            context.SaveChanges();
